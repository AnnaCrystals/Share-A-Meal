...
describe('TC-20x user', () => {
  describe('TC-201 Registreren als nieuwe user', () => {
    ...
    //       const { firstName, lastName, street, city, isActive, emailAddress, password, phoneNumber } = res.body.data;
    ...
    // Add the remaining test cases below
    ...
    it('TC-202-1 Toon alle gebruikers (minimaal 2)', (done) => {
      chai
        ...
        .end((err, res) => {
          ...
          res.body.should.have.property('message');
          res.body.should.have.property('data').to.not.be.empty;
          res.body.data.should.be.an('array').with.length.gte(2);
          done();
        });
    });
    // it('TC-202-1 Toon alle gebruikers (minimaal 2)', (done) => {
    ...
    it('TC-204-2 Gebruiker-ID bestaat niet', (done) => {
      chai.request(server)
        ...
        .end((err, res) => {
          ...
          res.body.should.have.property('data').to.be.empty;
          res.body.should.have.property('message').that.equals('User met ID 9999999 niet gevonden')
          done();
        });
    });


    //Deze ook misschien aanpassen
    ...
    it('TC-206-1 Gebruiker bestaat niet', (done) => {
      chai.request(server)
        ...
        .end((err, res) => {
          ...
          res.body.should.have.property('status').that.equals(404);
          res.body.should.have.property('data').to.be.empty;
          res.body.should.have.property('message').that.equals('User met ID 99999999999999 niet gevonden');
          done();
        });
    });
